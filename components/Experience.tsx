        ...
        <div className=" flex items-center justify-center  ">
            <div className="flex flex-col md:flex-row items-center container   py-6 md:py-12 space-y-6 md:space-y-0 md:space-x-8">
                <div className="w-full md:w-1/2 text-center md:text-left space-y-4">
                    ...
                    <h1 className="text-4xl font-bold text-gray-900">A Journey of Continuous Learning and Innovation</h1>
                ...
                <div className="w-full md:w-1/2 ">
                    <div className="relative  p-2">
                        <Image src="/images/14.png" alt="Profile Image" width={460} height={400} className=" object-cover" />
                    </div>
                </div>
            </div>
        </div>
