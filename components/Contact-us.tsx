            ...
            <div className="ml-8">
                ...
                <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <h3 className="text-lg font-semibold text-gray-800 mt-4">Call Now</h3>
                        <p className="text-gray-600 mt-2">
                            Continue indulged speaking the was out horrible for domestic position. Seeing rather her you not esteem men settle genius.
                        </p>
                        <div className="flex items-center gap-2">
                            <Link href="#" className=" w-10 h-10 cursor-pointer bg-custom-gradient rounded-lg relative inline-block text-center">
                                <Phone className='text-white absolute p-1 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2' size={32} />
                            </Link>
                            <p className="text-gray-600"> +91 91407 91082
                            </p>
                        </div>
                        <div className="flex items-center gap-2">
                            <Link href="#" className=" w-10 h-10 cursor-pointer bg-custom-gradient rounded-lg relative inline-block text-center">
                            ...
                            <p className="text-gray-600 "> +91 73098 77627
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <Link href="#" className=" w-10 h-10 cursor-pointer bg-custom-gradient rounded-lg relative inline-block text-center">
                                <Instagram className='text-white absolute p-1 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2' size={32} />
                            </Link>
                        </div>
                    </div>
                </div>
